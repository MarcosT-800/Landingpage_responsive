...
const MortalKombatCharacterCard: React.FC<MortalKombatCharacterCardProps> = ({ character }) => {
  ...
  <div className='aspect-w-4 aspect-h-5'>
    <Image
      src={character.image} // Caminho atualizado
      alt={`${character.name} model`}
      width={250} // Largura ajustada para 50 pixels
      height={250 * (5 / 4)} // Mantenha a proporção
      objectFit="cover" // Mantenha a proporção e cubra o contêiner
    />
  </div>
</div>
